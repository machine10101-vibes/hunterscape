...
const CASES = [
  ...
  // Chamber / coil stay in front (+Z). The old windup tip sat at Z=-0.34 and
  // the Euler lerp to the strike cut through the spine.
  caseOf('slash-chamber', 'sword', [0.02, -0.34, -0.05], [0.04, -0.22, -0.04], [0.04, -0.18, -0.18],
    [0.46, 1.92, 0.55], [0.4, 1.22, 0.36], [0.38, 1.26, 0.34]),
  caseOf('slash-windup', 'sword', [-0.08, -0.52, -0.08], [0.04, -0.36, -0.05], [-0.12, -0.24, -0.28],
    [0.56, 2.12, 0.28], [0.44, 1.5, 0.24], [0.42, 1.46, 0.22]),
  // Apex starts the descending line: tip comes across and forward while the hilt stays high-right.
  caseOf('slash-apex', 'sword', [0.04, -0.16, -0.02], [0.02, -0.08, 0.0], [0.02, -0.08, -0.1],
    [0.16, 1.86, 0.84], [0.38, 1.52, 0.42], [0.36, 1.5, 0.4]),
  // Contact is a diagonal, tip lower than the hilt, still well in front.
  caseOf('slash-strike', 'sword', [0.18, 0.42, 0.1], [0.0, 0.24, 0.06], [0.16, 0.12, 0.1],
    [-0.32, 0.78, 0.88], [0.28, 1.28, 0.46], [0.26, 1.26, 0.44]),
  caseOf('slash-follow', 'sword', [0.14, 0.56, 0.12], [-0.02, 0.3, 0.06], [0.18, 0.16, 0.12],
    [-0.52, 0.52, 0.58], [0.06, 1.02, 0.42], [0.04, 1.04, 0.4]),
  caseOf('slash-recover', 'sword', [0.1, 0.18, 0.06], [0.02, 0.1, 0.04], [0.12, 0.0, 0.02],
    [0.0, 1.58, 0.78], [0.22, 1.1, 0.4], [0.24, 1.12, 0.38]),
  // --- hatchet ---
