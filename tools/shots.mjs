...
const DEFAULT = [
  ...
  { name: 'slash-g38', o: { pose: 'slash', t: 0.38, az: 0.0, el: 0.69 } },
  { name: 'slash-g60', o: { pose: 'slash', t: 0.6, az: 0.0, el: 0.69 } },
  { name: 'sword-walk-b', o: { pose: 'sword-walk', t: 0.72, speed: 0.55, az: 0.7 } },
...
const SETS = {
  ...
  monsters: [
    ...
    { name: 'yeti-attack-side', o: { model: 'yeti', pose: 'attack', t: 0.55, az: 1.45, dist: 6.5, look: 1.6 } },
    { name: 'yeti-face', o: { model: 'yeti', pose: 'idle', t: 1.0, az: 0.3, dist: 2.2, look: 2.3, fov: 34 } },
    { name: 'yeti-back', o: { model: 'yeti', pose: 'idle', t: 1.0, az: 3.4, dist: 6.5, look: 1.6 } },
    { name: 'yeti-paw', o: { model: 'yeti', pose: 'idle', t: 1.0, az: 0.55, el: 1.5, dist: 2.0, focus: 'yetiHandL', fov: 32 } },
    { name: 'yeti-foot', o: { model: 'yeti', pose: 'idle', t: 1.0, az: 0.55, el: 1.3, dist: 1.7, focus: 'yetiFootR', fov: 32 } },
    ...
    { name: 'orc-attack-side', o: { model: 'orc', pose: 'attack', t: 0.52, az: 1.45, dist: 5.0, look: 1.2 } },
    { name: 'orc-attack-front', o: { model: 'orc', pose: 'attack', t: 0.52, az: 0.05, dist: 4.6, look: 1.2 } },
